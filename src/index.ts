...
export function h(tag: string | ComponentFactory, attrs: { [s: string]: string | number | boolean | EventListenerOrEventListenerObject }, ...children: ComponentChild[]): JSX.Element {
